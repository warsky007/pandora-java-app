package io.qiniu.appsdk.client;
...
import io.qiniu.appsdk.utils.JsonHelper;
import io.qiniu.appsdk.utils.RestUtils;
...
public class PandoraClient {
  ...
  public HttpResponse register(String app, String service, String ip, String port, String token) throws IOException {
  ...
  private byte[] checkResponse(HttpResponse response) throws IOException {
    ...
    if (response.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
      ...
      throw new IllegalArgumentException(String.format("reqId: %s, code: %s, message: %s", phoenixExceptionResponse.getRequestId(), phoenixExceptionResponse.getCode(), phoenixExceptionResponse.getMessage()));
    }
    return content;
  }
